...
public class ZclGenericAppliance extends ZclAppliance {
	...
	private ZclEndPoint zclAllocateEndPoint(int app_end_point_id, int profile_id, int device_id, int end_point_id, int manufacturer_code, int[] clientClusterIds,
			int[] serverClusterIds) throws ApplianceException {
	...
	protected void attached() {
		...
		// sleeping end device reporting configuration, reading zone status
		// type,...)
	...
	protected synchronized ZclEndPoint zclGetEndPoint(int epsNumber, int profile_id, int device_id, int end_point_id, int manufacturer_code, List clientClusterIds,
			List serverClusterIds) throws ApplianceException {
